    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">INNOVOLK
                </a>
            </div>
        ...
        <div class="item">
            <div class="container">
                <div class="carousel-caption blank">
                    <h1>SELF-ASSESS <br/>INVESTMENT<br/>ANALYSIS &nbsp;SYSTEM</h1>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="img/landing/avatar3.jpg" class="img-responsive img-circle img-small" alt="" style="height:200px;width:200px">
