                                ...
                                @foreach($data->room as $key=>$val)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btn btn-primary btn-xs J_user_info" data-toggle="modal" data-target="#myModal" data-id="{{$key}}" style="margin:0px;padding:0px 5px;border-top: 0;">添加宿舍</button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
