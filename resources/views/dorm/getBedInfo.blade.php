                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content form-horizontal" style="padding-bottom:15px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                @if($data->depart)
                                    {{--<select class="form-control m-b J_depart" name="depart" disabled>--}}
                                        {{--<option @if($data->depart) selected @endif>{{$data->depart}}</option>--}}
                                    {{--</select>--}}
                                    <select class="form-control m-b J_depart" name="depart">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="姓名" class="form-control J_name"
                                       value="{{$data->name}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="身份证" class="form-control J_card"
                                       value="{{$data->card}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="电话号" class="form-control J_phone"
                                       value="{{$data->phone}}"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content form-horizontal" style="padding-bottom:15px;">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select data-placeholder="选择房间" class="chosen-select" tabindex="-1"
                                            style="display: none;">
                                        <option value="">请选择</option>
                                        @foreach($adjust as $v)
                                            <option value="{{$v->id}}">{{$v->dorm_name}}{{$v->floor}}楼{{$v->room}}
                                                房{{$v->bed}}床
                                            </option>
                                        @endforeach
                                    </select>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.J_inroom').click(function () {
                ...
                var card = $('.J_card').val();
                var phone = $('.J_phone').val();
                var depart = $('.J_depart option:selected').val();
